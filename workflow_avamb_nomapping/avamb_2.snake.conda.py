...
def bam_files_creation_check_f(wildcards):
    """If bam files are already created, skip mapping part """
    with checkpoints.bam_files_creation_check.get().output[0].open() as f:
...
checkpoint bam_files_creation_check:
    input:
