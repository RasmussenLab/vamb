...
PlasMAAG (_Plas_mid and organism *M*etagenomic binning using *A*ssembly *A*lignment *G*raphs) is a framework to recover *plasmids* and *organisms* from *metagenomic* samples, offering state-of-the-art plasmid reconstruction with reduced computational costs.
