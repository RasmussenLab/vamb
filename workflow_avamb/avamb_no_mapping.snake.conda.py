...
# set configurations
ABUNDANCES_FILE = get_config("abundances", "abundances.npz", r".*")
CONTIGS_FILE = get_config("fastafile", "contigs.fna", r".*")
...
rule run_avamb:
    ...
    shell:
        ...
        "{AVAMB_PRELOAD}"
        "vamb --outdir {output.outdir_avamb} --fasta {input.contigs}  --rpkm {input.abundance} {params.cuda} {AVAMB_PARAMS}; "
        "touch {log}"
