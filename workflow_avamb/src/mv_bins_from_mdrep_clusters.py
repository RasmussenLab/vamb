...
def main(cluster_scores, cluster_contigs, bin_separator, path_nc_bins_folder , path_bins_folder, path_nc_clusters):
    ...
    write_nc_bins_from_mdrep_clusters(nc_cluster_scores,cluster_sample, path_nc_bins_folder, path_bins_folder)
...
def write_nc_bins_from_mdrep_clusters(cluster_scores,
                                      cluster_sample,
                                      path_nc_bins_folder,
                                      path_bins_folder):
