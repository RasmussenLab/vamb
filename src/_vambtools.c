 ...
 */
    __pyx_t_7 = __pyx_v_i;
    __pyx_t_6 = (((*((unsigned char *) ( /* dim=0 */ ((char *) (((unsigned char *) __pyx_v_mask.data) + __pyx_t_7)) ))) == 1) != 0);
    if (__pyx_t_6) {
 ...
 */
        ...
        *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_13 * __pyx_v_matrix.strides[0]) )) + __pyx_t_14)) )) = (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_11 * __pyx_v_matrix.strides[0]) )) + __pyx_t_12)) )));
      }
