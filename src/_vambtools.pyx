...
cdef void c_kmercounts(unsigned char[::1] bytesarray, int k, int[::1] counts):
    ...
    cdef int charvalue
    cdef int i
    cdef int countdown = k
    cdef int contiglength = len(bytesarray)
    cdef int mask = (1 << (2 * k)) - 1
    cdef unsigned char* lur = [255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
                           255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
                           255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
                           255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
                           255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
                           255, 255, 255, 255, 255, 0, 255, 1, 255, 255, 255, 2, 255,
    ...
    for i in range(contiglength):
        ...
        charvalue = lur[character]
        countdown = k if charvalue == 255 else max(0, countdown-1)
